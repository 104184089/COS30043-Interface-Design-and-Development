            ...
            <nav id="nav_bar" class="w-100">
                <div class="nav-content">
                    ...
                    <div class="nav-right">
                        ...
                        <router-link class="btn btn-outline-primary btn-login" to="/login" v-if="!$root.authenticated">Log in<v-icon>mdi-login</v-icon></router-link>
                        <router-link class="btn btn-outline-primary btn-login" to="/logout" v-if="$root.authenticated" v-on:click="logout()">Log out<v-icon>mdi-logout</v-icon></router-link>
                    </div>
                </div>
            </nav>
        </div>
